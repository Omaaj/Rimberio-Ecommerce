    ...
    <div>
      <div className="slider">
        ...
        <div className="iconss">
            <div className="icons">
                <div className="icon one" onClick={prevSlide}><WestOutlinedIcon sx={{fontSize: "20px"}}/></div>
                <div className="icon" onClick={nextSlide}><EastOutlinedIcon sx={{fontSize: "20px"}}/></div>
            </div>
        </div>
      </div>
