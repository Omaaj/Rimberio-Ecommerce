...
export default function AdminAddNew() {
    ...
    const handleInputChange = (e) => {
      ...
      const handleImageChange = (e) => {
        ...
        // console.log(file);
        const storageRef = ref(storage, `rimberioss1/${Date.now()}${file.name}`);
    ...
    const addProducts = (e) => {
        ...
        try {
          const docRef = addDoc(collection(db, "new-Products"), {
          ...
          navigate("/admin/all-new-products")
        } catch (error) {
          toast.error(error.message)
        }
    }
    ...
    const editProducts = (e) => {
      ...
      return (
        <div className='admin_productss'>
          <h1>{detectForm(id, "Add New Arrivals Product", "Edit Product")}</h1>
          <div className="cards">
