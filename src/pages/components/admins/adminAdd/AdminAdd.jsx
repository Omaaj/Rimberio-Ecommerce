...
export default function AdminAdd() {
  ...
  const handleImageChange = (e) => {
    ...
    // console.log(file);
    const storageRef = ref(storage, `rimberioss/${Date.now()}${file.name}`);
  ...
  const tags = [
    ...
    },
    {
      id : 10,
      name : "trousers",
      subname : "womentrousers"
    },
    {
      id : 11,
      name : "glasses",
      subname : "womenglasses"
    },
    {
      id : 12,
      name : "watches",
      subname : "womenwatches"
    },
  ]
