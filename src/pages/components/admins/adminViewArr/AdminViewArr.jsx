...
export default function AdminViewArr() {    
  ...
  const deleteProducts = async (id, img) => {
    try {
      await deleteDoc(doc(db, "new-Products", id));
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="actionss">
                              <Link className='links_ad' to={`/admin/add-new-products/${id}`}>
                                <FaEdit/>
                              </Link>
